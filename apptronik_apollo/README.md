# Apptronik Apollo Simulation Assets

## Overview

This package contains robot assets for the [Apollo](https://apptronik.com/apollo) humanoid robot developed by [Apptronik](https://apptronik.com/).
